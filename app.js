...
function AddToReceipesListOne(receipeone, index = 1) {
  ...
  receipeDiv.classList = ` receipe col-sm-2 row px-0 mx-auto`;
  receipeDiv.setAttribute("data-aos", "fade-right");
  receipeDiv.setAttribute("data-aos-delay", index * 100);
  receipeDiv.innerHTML = `

<img src=${receipeone.image} class="col-6 col-sm-12 p-0 receipe-image" alt=""/>
   <div class="receipe-body col-6 col-sm-12">
...
function AddToReceipesListTwo(receipetwo, index = 1) {
  ...
  receipeDiv.classList = `col-sm-2 row mx-auto receipe px-0`;
  receipeDiv.setAttribute("data-aos", "fade-up");
  receipeDiv.setAttribute("data-aos-delay", index * 100);
  receipeDiv.innerHTML = `
 <img src=${receipetwo.image} class="col-6 col-sm-12 p-0 receipe-image" alt=""/>
  <div class="receipe-body col-6 col-sm-12">
...
function AddToReceipesListThree(receipethree, index = 1) {
  ...
  receipeDiv.setAttribute("data-aos-delay", index * 100);
  receipeDiv.innerHTML = `<img src=${receipethree.image} class="col-6 col-sm-12 p-0 receipe-image" alt=""/>
 <div class="receipe-body col-6 col-sm-12">
...
function saveToCart(event) {
  ...
  const description = receipeRow.querySelector(
    ".receipe-description"
  ).textContent;
